  ...
  return (
    <div className='animate-fade-in-up'>
      <div className='mb-12 mt-8 text-5xl'>
        <p className='mb-4 font-appleSemiBold'>🚗 얻어타다</p>
      </div>
      <hr className='mb-8' />
      <div className='mb-8'>
      ...
      <div className='mb-8'>
        ...
        <li className='font-appleMedium'>Back End : Java, Spring</li>
        <li className='font-appleMedium'>Database : Oracle</li>
        <li className='font-appleMedium'>Deployment : -</li>
      </div>
    </div>
  );
};
