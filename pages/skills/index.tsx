...
import IconTailwindCSS from "../../assets/images/tailwindCss.svg";
...
const skills = () => {
  return (
    <div className='flex flex-col'>
      <div className='text-3xl w-full animate-fade-in-up flex flex-row justify-between font-appleBold z-10'>
        <SkillsCard>
          ...
          <div className='grid grid-cols-2 gap-2 place-items-center mt-3'>
            ...
            <IconTailwindCSS width='130' height='130' />
